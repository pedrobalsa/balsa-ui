...
const classes = computed(() =>
  mergeClasses(
    "relative inline-flex shrink-0 select-none items-center justify-center overflow-hidden border border-balsa-border bg-balsa-muted font-balsa-body font-bold text-balsa-muted-foreground",
