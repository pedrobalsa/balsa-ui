...
<template>
  <ul data-balsa="chart-legend" class="flex flex-wrap items-center justify-center gap-x-balsa-lg gap-y-balsa-xs text-xs text-balsa-chart-axis">
    <li v-for="(key, index) in keys" :key="key" class="flex items-center gap-balsa-2xs">
