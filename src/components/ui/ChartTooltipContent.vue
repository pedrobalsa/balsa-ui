...
<template>
  <div data-balsa="chart-tooltip-content" class="min-w-36 rounded-balsa-control border bg-balsa-chart-tooltip p-2.5 text-xs text-balsa-chart-tooltip-foreground shadow-balsa-overlay">
    <p v-if="label" class="mb-2 font-medium text-balsa-muted-foreground">{{ label }}</p>
