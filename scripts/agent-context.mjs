...
function agentInstructions() {
  return [
    ...
    "## Balsa UI",
    "",
    "- Read `.balsa/catalog-index.json` before creating UI, then read only the selected `.balsa/specs/components/<name>.json`.",
    "- Prefer a matching Balsa component over rebuilding controls. Install missing items with `npx balsa-ui@latest add <name>`.",
