...
const presetPath = sourcePath("src/components/ui/text-3d-presets.json");
const gradientPresetPath = sourcePath("src/components/ui/gradient-background-presets.json");
